...
In Abbildung \ref{fig:concepts} sind die drei Spielekonzepte in Stichpunkten zusammengefasst auf der Abstimmungstafel zu sehen. In Spielekonzept 1 (SK1) war die Idee, dass die Spieler erst, wenn Sie ihre Zeichnung fertig gestellt haben und auf einen Bestätigungsknopf gedrückt haben, die Vorhersagen der künstlichen Intelligenz angezeigt bekommen. Das zweite Spielekonzept (SK2) unterschied sich vom ersten insofern, dass die Vorhersagen der KI immer sichtbar sein sollten. Der Unterschied zwischen dem dritten und zweiten Konzepte sollte sein, dass hier nur eine festzulegende Anzahl an Vorhersagen angezeigt werden sollten.\\
Zuletzt fiel die Abstimmungsergebnis für das Spielkonzept 2 mit vier Stimmen von acht. Die beiden anderen Konzepte bekamen jeweisl zwei Stimmen.
