...
\begin{figure}[ht]
\centering
    \subfigure[Tutorial: Erster Schritt]{\includegraphics[width=0.3\textwidth]{images/tutorial1.png}}
    \subfigure[Tutorial: weitere Schritte]{\includegraphics[width=0.3\textwidth]{images/tutorial2.png}}
...
\begin{figure}[ht]
\centering
    \subfigure[VictoryScreen]{\includegraphics[width=0.3\textwidth]{images/Victoryscreen.jpg}}
    \subfigure[DefeatScreen]{\includegraphics[width=0.3\textwidth]{images/Defeatscreen.jpg}}
